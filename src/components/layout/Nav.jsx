...
export default function Nav({
  ...
  return (
    <div>
      <nav
        className="w-full max-w-md mx-auto fixed -bottom-5 left-0 right-0 z-10 rounded-t-2xl border-t border-gray-200 bg-white"
        style={{
          paddingBottom: "max(env(safe-area-inset-bottom), 0px)",
        }}
      >
        <div className="container mx-auto px-4 h-[5.3rem]">
